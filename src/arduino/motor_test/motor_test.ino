...
// indexed by PWM, store angular velocity at that PWM

// store decimals as *100 shorts for memory reasons; 16.47 == 1647

// TODO move to PROGMEM

// TODO consider changing to encoder tick counts
...
void loop() {
    ...
    calc_vel(fr_ticks, fr_ticks_prev, fr_time_prev, fr_vel);
    calc_vel(rl_ticks, rl_ticks_prev, rl_time_prev, rl_vel);
    calc_vel(rr_ticks, rr_ticks_prev, rr_time_prev, rr_vel);
}